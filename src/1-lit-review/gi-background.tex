...
Unlike scientific simulations, graphics pipelines often demand realtime (near-instantaneous) results, which places tight limits on computational cost.
...
Ray tracing techniques, alternatively,  directly simulate light paths and their interactions with the environment, but until recently was prohibitively expensive for consumer hardware, not to mention unreasonably time-consuming to render each frame.
