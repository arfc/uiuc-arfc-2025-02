Deterministic neutron transport techniques are commonly developed around the expansion of the \acrshort{bte}'s scattering source term in angle ($\mathbf{\Omega}$) using orthogonal basis functions.
