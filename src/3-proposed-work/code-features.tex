...
\acrshort{rc} is a deterministic method, and so the energy dependence is discretized using either the multigroup approximation or some other discretization scheme (charged particle transport). As such, there must be some sort of cross section interface, allowing users to specify multigroup cross sections for geometric regions.
