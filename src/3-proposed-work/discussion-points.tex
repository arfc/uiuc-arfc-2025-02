...
A 3D implementation of \glspl{rc} is absolutely feasible, however the scaling law that makes \glspl{rc} so interesting in 2D does not apply in 3D (atleast not trivially like in 2D).
