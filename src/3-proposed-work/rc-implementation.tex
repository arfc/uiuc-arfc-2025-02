...
Additionally, OpenMOC is outdated and needs a lot of code maintenance prior to implementing \glspl{rc}, although this will be discussed further in~\ref{subsubsec:implementation-outline}.
...
Additionally, OpenMOC was intended to be able to interface with OpenMC, specifically for geometry and cross section generation. 
...
\begin{enumerate}
    ...
    \item Code cleanliness: Some of the source files are extremely long, and could benefit from templating and unnecessary function/variable deletion.
    ...
    Additionally, using PETSc gaurantees adequate performance, scalability, and portability (PETSc support Kokkos).
