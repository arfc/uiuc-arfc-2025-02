...
\acrlong{rc} do not have a stochastic element, and thus do not belong in OpenMC.
...
\begin{enumerate}
    ...
    \item The standard \glspl{rc} merging algorithm and Bilinear fix merging algorithm
\end{enumerate}
