...
%    \item The requirements of \glspl{rcs} lie in the spacing between probes with regard to their angular resolution.
...
Because \acrlong{rcs} primarily impose constraints on probe spacing relative to angular resolution, these tools could be adapted directly.
...
Since \acrshort{rcs} only require interpolation between probe values, schemes such as linear, quadratic, or even spline-based interpolation could be evaluated.
