...
% Place and date of pubkdhuff@illinois.edulication
...
\newcommand{\rc}{Radiance Cascades}
...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \vspace{0.2cm}
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries Internal Proposal for Implementation of Radiance Cascades to Neutral Particle Transport
                           \end{flushright}}
        {\begin{flushright}\large\textit{Subtitle TBD}\end{flushright}}
        \end{minipage}
    ...
    %------------------------------------------------
       ...
       \begin{minipage}{0.4\textwidth}
               \begin{flushright}
                       \large
                       \textit{Prepared by:}\\
                       Nathan  \textsc{Glasser}\\ %
                       Liam \textsc{Pohlmann} %
                       \vspace{4mm}\\
                       \textit{Principal Investigators:}\\ %
                       Prof. Kathryn D. \textsc{Huff}\\
		       Prof. Madicken Munk % Supervisor's name
               \end{flushright}
    \end{minipage}
    ...
    %------------------------------------------------
    \vspace{1cm}
    \textsc{\LARGE\bfseries UIUC-ARFC-2025-02} % Replace YYYY with the year, NN with report index
    \vspace{0.5cm}
    ...
    {\large December 15, 2025} % January 1, 3000
...
\bibliography{uiuc-arfc-2025-02}
\end{document}
